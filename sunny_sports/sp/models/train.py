...
class Train(models.Model):
    ...
    org_id = models.ForeignKey(Coach_Org) #组织机构
    ...
    sub_status = models.IntegerField(choices=SUB_STATUS) #成绩是否提交
    pub_status = models.IntegerField(choices=PUB_STATUS) #成绩是否发布
