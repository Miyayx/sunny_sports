...
urlpatterns += patterns('sp.centre_views',
        ...
        url(r'^centre/ch_team_payment_st$','change_team_payment_status'),
        )
...
urlpatterns += patterns('sp.coach_views',
        ...
        url(r'^coach/strain/pay_notify$', 'pay_notify'),
        url(r'^coach/strain/pay_return$', 'pay_return'),
...
urlpatterns += patterns('game.views',
        ...
        url(r'^find_stu/(?P<phone>\w+)/(?P<gender>\d)', 'find_stu'),
